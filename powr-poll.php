<?php
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Poll widget/////////////////////////////////
    class Powr_Poll extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_poll',
                             __( 'POWr Poll' ),
                             array( 'description' => __( 'Poll by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-poll' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Poll.
        </p>
        <p>
    ...
    function register_powr_poll() {
      register_widget( 'Powr_Poll' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_poll' );
    //Create short codes for adding plugins anywhere:
    function powr_poll_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-poll' label='$label'></div>";
    }
    add_shortcode( 'powr-poll', 'powr_poll_shortcode' );
  ?>